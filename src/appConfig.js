...
const OC_QUESTIONS = [
  ...
  { id: 'q9',  type: 'choice', prompt: 'Scenario 1: Two criminals are attempting to attack the Vice-Mayor. You have one other Agent with you. What do you do?',
    choices: ['Both agents engage the criminals directly', 'One agent covers the Vice-Mayor while the other engages', 'Retreat with the Vice-Mayor to a safe position and call backup', 'Radio for backup and hold position without engaging'] },
  { id: 'q10', type: 'choice', prompt: 'Scenario 2: A Mafia with 4 members is planning to hostage a Whitelisted. You have 2 SRT and 3 HSI online. How do you handle it?',
    choices: ['Send all 5 members in at once', 'Deploy SRT to engage while HSI secures the Whitelisted', 'Wait for more backup before acting', 'Send HSI alone since it is an intelligence matter'] },
  { id: 'q11', type: 'choice', prompt: 'Scenario 3: You are protecting the President. Three attackers enter with AK-47s. You have 2 Agents with pistols and 1 Agent with a rifle. How do you respond?',
    choices: ['All agents engage the attackers at once', 'Rifle Agent suppresses attackers while pistol Agents evacuate the President', 'Evacuate the President immediately and do not engage', 'Have all agents form a shield around the President and wait'] },
  { id: 'q12', type: 'choice', prompt: 'Scenario 4: You are raiding a Mafia with 3 SRT members against 5 Mafia members. How do you approach this?',
    choices: ['Rush in with all 3 SRT members at once', 'Breach in a stack, clear room by room, and arrest where possible', 'Wait outside and attempt negotiation first', 'Call off the raid due to being outnumbered'] },
  { id: 'q13', type: 'choice', prompt: 'There is an active operation but no Lead Supervisor is online and one is required. What do you do?',
    choices: ['Volunteer to fill the LS role', 'Cancel the operation', 'Run the operation without an LS', 'Wait until one comes online'] },
  { id: 'q14', type: 'choice', prompt: 'The Director of Operations wants to promote someone to the Executive Branch. Do you approve?',
...
const EB_QUESTIONS = (rankName) => [
  { id: 'q1',  type: 'text',   prompt: 'What is your Roblox username?' },
  { id: 'q2',  type: 'text',   prompt: 'What is your Discord username?' },
  { id: 'q3',  type: 'text',   prompt: 'What is your current rank in DHS? If you are not an agent simply put N/A.' },
  { id: 'q4',  type: 'choice', prompt: 'You just performed a raid and one Agent is down. What do you do?',
    choices: ['Push forward and continue the raid', 'Fall back and reassess the situation', 'Call for medical support and hold position', 'Abandon the raid entirely'] },
  { id: 'q5',  type: 'choice', prompt: 'You are in pursuit of a suspect who has entered a house. You have 3 SRT members including yourself. What do you do?',
    choices: ['Raid the house immediately', 'Attempt to get them to surrender first', 'Surround the house and wait for backup', 'Call off the pursuit'] },
  { id: 'q6',  type: 'choice', prompt: 'You are protecting the mayor when multiple suspects show up with AKs. You have 4 other agents. What do you do?',
    choices: ['All agents engage the suspects immediately', 'Two agents secure the mayor while three engage', 'Evacuate the mayor and avoid direct engagement', 'Hold position and radio for backup'] },
  { id: 'q7',  type: 'choice', prompt: `Why are you applying for ${rankName}? Give your honest reason.`,
    choices: ['I want to contribute more to DHS leadership', 'I feel ready for more responsibility', 'I was encouraged by senior staff', 'I want to improve DHS operations'] },
  { id: 'q8',  type: 'text',   prompt: `What makes you a strong candidate for ${rankName} specifically?` },
  { id: 'q9',  type: 'choice', prompt: 'A Lead Supervisor asks you to handle a side task for them. Do you take it on?',
    choices: ['Yes, without hesitation', 'Only if my current duties allow it', 'No, it is not my responsibility', 'Ask for clarification on the task first'] },
  { id: 'q10', type: 'choice', prompt: 'There are 2 pending tasks for the Executive Branch and nobody has picked them up. You understand both. What do you do?',
    choices: ['Take both on immediately', 'Take one and flag the other to a superior', 'Wait to be assigned', 'Notify a senior member and let them decide'] },
  { id: 'q11', type: 'choice', prompt: 'A deployment is active to capture criminals. Do you join?',
    choices: ['Yes, always', 'Only if I am available and not on another task', 'No, that is not my role', 'Only if directly ordered to'] },
  { id: 'q12', type: 'choice', prompt: 'How active are you on a weekly basis?',
    choices: ['1–2 hours', '3–5 hours', '6–10 hours', '10+ hours'] },
  { id: 'q13', type: 'choice', prompt: 'How do you handle a conflict between two members of your team?',
    choices: ['Let them sort it out themselves', 'Mediate and resolve it professionally', 'Escalate to a superior immediately', 'Discipline both parties on the spot'] },
  { id: 'q14', type: 'text',   prompt: 'What would you do differently from the current leadership to improve DHS operations?' },
  { id: 'q15', type: 'choice', prompt: 'Do you agree that using AI on this application will result in a blacklist?',
    choices: ['Yes, I agree', 'No'] },
  { id: 'q16', type: 'choice', prompt: 'Do you agree not to ask staff to read or rush your application?',
    choices: ['Yes, I agree', 'No'] },
];
...
export const RANKS = [
  ...
  },
  {
    ...
    questions: EB_QUESTIONS('Director of Operations'),
  },
  {
    id: '1496618836751814757',
    name: 'Deputy Director of Operations',
    questions: EB_QUESTIONS('Deputy Director of Operations'),
  },
  {
    id: '1496620834796601395',
    name: 'Assistant Director of Operations',
    questions: EB_QUESTIONS('Assistant Director of Operations'),
  },
  {
    id: '1496622105079320728',
    name: 'Director of Operations Intern',
    questions: EB_QUESTIONS('Director of Operations Intern'),
  },
  {
